        ...
        <table style={{ width: "100%", borderCollapse: "collapse", textAlign: "left", fontSize: "0.85rem" }}>
          <thead>
            <tr style={{ borderBottom: "1px solid var(--border-color)", color: "var(--text-secondary)" }}>
              <th style={{ padding: "0.5rem 0.5rem", fontWeight: 700, width: "25%" }}>Driver</th>
              <th style={{ padding: "0.5rem 0.5rem", fontWeight: 700, width: "20%" }}>License</th>
              <th style={{ padding: "0.5rem 0.5rem", fontWeight: 700, width: "20%" }}>Expiry</th>
              <th style={{ padding: "0.5rem 0.5rem", fontWeight: 700, width: "10%" }}>Days</th>
              <th style={{ padding: "0.5rem 0.5rem", fontWeight: 700, width: "15%" }}>Status</th>
              <th style={{ padding: "0.5rem 0.5rem", fontWeight: 700, textAlign: "right", width: "10%" }}>Action</th>
            </tr>
          </thead>
          <tbody>
            {!expiringDrivers || expiringDrivers.length === 0 ? (
              <tr>
                <td colSpan="6" style={{ padding: "2rem 0.5rem", textAlign: "center", color: "var(--text-muted)" }}>
              ...
              expiringDrivers.map((drv) => (
                <tr key={drv.id} style={{ borderBottom: "1px solid var(--border-color)", color: "var(--text-primary)" }}>
                  ...
                  <td style={{ padding: "0.75rem 0.5rem", fontFamily: "monospace" }}>{drv.license}</td>
                  <td style={{ padding: "0.75rem 0.5rem" }}>{drv.expiryDate}</td>
                  <td style={{ padding: "0.75rem 0.5rem", fontWeight: 700 }}>{drv.daysRemaining}d</td>
